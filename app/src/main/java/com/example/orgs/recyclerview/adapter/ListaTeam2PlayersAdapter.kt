...
class ListaTeam2PlayersAdapter(
    private val context: Context,
    private val players: List<Player>
) : RecyclerView.Adapter<ListaTeam2PlayersAdapter.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun vincula(player: Player) {
            val nickname = itemView.findViewById<TextView>(R.id.team2PlayersNickname)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val itemView = inflater.inflate(R.layout.team2_player_card, parent, false)
